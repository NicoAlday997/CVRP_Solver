...
class CVRP:
    ...
    def encontrar_cliente_mas_cercano(self, cliente_actual, clientes_disponibles):
        ...
        for cliente in clientes_disponibles:
            distancia = self.distancias[cliente_actual][cliente]
    ...
    def construir_rutas(self):
        ...
        while clientes_no_asignados:
            ...
            capacidad_restante -= self.demandas[cliente_inicial]
            ...
            while capacidad_restante > 0:
                ...
                if cliente_mas_cercano is None or self.demandas[cliente_mas_cercano] > capacidad_restante:
                    break
